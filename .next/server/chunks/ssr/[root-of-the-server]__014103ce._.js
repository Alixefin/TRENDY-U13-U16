      ...
      `);
        if (teamsError) {
            ...
            if (matchesError) {
                ...
                setMatches(matchesData?.map((m)=>mapSupabaseMatchToLocal(m, fetchedTeams)) || []);
            }
        }
        setIsLoading(false);
    }, [
            ...
            for (const { teamId, matchScore, opponentMatchScore } of teamsToProcess){
                ...
                if (groupTeamEntries && groupTeamEntries.length > 0) {
                    for (const groupTeamEntry of groupTeamEntries){
                        ...
                        const { error: updateError } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('group_teams').update(updates).eq('id', groupTeamEntry.id); // group_teams has its own 'id' primary key
                        if (updateError) {
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: [
                                                ...
                                                selectedMatch.events && selectedMatch.events.length > 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("ul", {
                                                    className: "max-h-40 overflow-y-auto border rounded-md p-2 space-y-1",
                                                    children: selectedMatch.events.map((event)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("li", {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__014103ce._.js.map