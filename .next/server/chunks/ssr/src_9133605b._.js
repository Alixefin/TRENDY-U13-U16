...
const createPlayer = (id, name, shirtNumber)=>({
        id,
        name,
        shirtNumber
    });
const placeholderLogo = (seed)=>`https://placehold.co/64x64/50C878/FFFFFF.png?text=${seed.substring(0, 1).toUpperCase()}&font=poppins`;
...
const mockTournamentInfo = {
    ...
    logoUrl: placeholderLogo('Trendy'),
...
const getTeamById = (id)=>mockTeams.find((team)=>team.id === id);
}}),
...
const goalEventSchema = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["object"])({
    playerId: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["string"])().min(1, "Select player"),
    time: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["string"])().min(1, "Enter time (e.g., 45+2')")
});
const cardEventSchema = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["object"])({
    playerId: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["string"])().min(1, "Select player"),
    cardType: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["enum"])([
        'yellow',
        'red'
    ]),
    time: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["string"])().min(1, "Enter time"),
    details: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["string"])().optional()
});
function AdminMatchesPage() {
    const [matches, setMatches] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["mockMatches"]);
    const [teams] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["mockTeams"]);
    ...
    const openEditModal = (match)=>{
        ...
        }); // Clone to allow local modifications
        updateForm.reset({
    ...
    const handleAddGoal = ()=>{
        ...
        const allPlayers = [
            ...selectedMatch.lineupA || selectedMatch.teamA.players,
            ...selectedMatch.lineupB || selectedMatch.teamB.players
        ];
    ...
    const onUpdateMatchSubmit = (data)=>{
        if (!selectedMatch) return;
        setIsUpdatingMatch(true);
        setMatches((prevMatches)=>prevMatches.map((m)=>m.id === selectedMatch.id ? {
                    ...m,
    ...
    const getPlayerTeam = (playerId1)=>{
        if (!selectedMatch) return undefined;
        if (selectedMatch.teamA.players.find((p)=>p.id === playerId1)) return selectedMatch.teamA;
        if (selectedMatch.teamB.players.find((p)=>p.id === playerId1)) return selectedMatch.teamB;
        return undefined;
    };
    const availablePlayersForEvents = selectedMatch ? [
        ...(selectedMatch.lineupA && selectedMatch.lineupA.length > 0 ? selectedMatch.lineupA : selectedMatch.teamA.players).map((p)=>({
                ...p,
                teamName: selectedMatch.teamA.name
            })),
        ...(selectedMatch.lineupB && selectedMatch.lineupB.length > 0 ? selectedMatch.lineupB : selectedMatch.teamB.players).map((p)=>({
                ...p,
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["CardFooter"], {
                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Button"], {
                                        ...
                                        children: isSubmittingMatch ? "Scheduling..." : "Schedule Match"
                                    }, void 0, false, {
                                        fileName: "[project]/src/app/admin/matches/page.tsx",
                                        lineNumber: 308,
                                        columnNumber: 15
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$dialog$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DialogFooter"], {
                                                ...
                                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Button"], {
                                                    ...
                                                    children: isUpdatingMatch ? "Updating Scores/Status..." : "Update Scores/Status"
                                                }, void 0, false, {
                                                    fileName: "[project]/src/app/admin/matches/page.tsx",
                                                    lineNumber: 429,
                                                    columnNumber: 19
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$dialog$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DialogFooter"], {
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Button"], {
                                            ...
                                            disabled: isUpdatingMatch,
                                            children: isUpdatingMatch ? "Saving All Changes..." : "Save All Changes"
                                        }, void 0, false, {
                                            fileName: "[project]/src/app/admin/matches/page.tsx",
                                            lineNumber: 503,
                                            columnNumber: 17
...
//# sourceMappingURL=src_9133605b._.js.map